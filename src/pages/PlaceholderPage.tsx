  ...
  return (
    <div className="flex min-h-full flex-col bg-neutral-gray-100 pb-24">
      <div className="flex flex-1 flex-col items-center justify-center gap-4 px-8 text-center">
        <BrandLogo variant="mark" className="h-16 w-16 rounded-2xl object-cover shadow-sm" />
        <div className="flex h-14 w-14 items-center justify-center rounded-full bg-zepto-purple-light">
